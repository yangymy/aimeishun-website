...
export function HeroSection() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-[#7A9E8C]/20 via-[#2C3E35] to-[#2C3E35]" />
      <div className="absolute inset-0 bg-gradient-to-b from-[#2C3E35]/60 via-[#2C3E35]/70 to-[#2C3E35]/90" />

      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#7A9E8C]/10 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-[#7A9E8C]/5 rounded-full blur-2xl" />
      ...
      <div className="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10 pt-[72px]">
        <div className="text-center max-w-4xl mx-auto py-16 md:py-24 lg:py-32">
          <div className="inline-block mb-6">
            <span className="text-sm font-medium text-[#7A9E8C] uppercase tracking-wider">
              爱美舜 · AIMEISHUN
            </span>
          </div>
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            20余年，只做好一件事——
            <span className="block mt-2 text-[#7A9E8C]">
              帮30+姐妹养出好皮肤
            </span>
          </h1>
          ...
          <p className="text-sm text-white/50 mt-8 flex items-center justify-center gap-2">
            <span className="inline-block w-2 h-2 bg-[#7A9E8C] rounded-full animate-pulse" />
            已有 1800+ 姐妹开启科学护肤之旅
          </p>
        </div>
      </div>
